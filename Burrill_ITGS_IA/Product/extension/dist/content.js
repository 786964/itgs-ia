...
var _ezyvet = __webpack_require__(465);

var ezyvet = _interopRequireWildcard(_ezyvet);
...
var ACTIONS = {
    animal_info: function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            return _context.abrupt("return", ezyvet.animal_info());
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 3:
                            _context2.next = 5;
                            return ezyvet.find_attachments(animal.id);
...
exports.find_attachments = undefined;

var find_attachments = exports.find_attachments = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(record_id, limit) {
        var attachments, query, fd, xhr, event, dp, doc, tbody, trs, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, tr, second_column, url;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 2:
                        ...
                        _context.next = 10;
                        return do_xhr(xhr, fd);

                    case 10:
                        event = _context.sent;
                        dp = new DOMParser();
                        doc = dp.parseFromString(event.target.response, "text/html");
                    ...
                    case 17:
                        ...
                        for (_iterator = trs[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            tr = _step.value;
                            second_column = tr.getElementsByTagName("td")[1];
                            url = second_column.getElementsByTagName("a")[0].href;
    ...
    return function find_attachments(_x, _x2) {
        return _ref.apply(this, arguments);
    };
}();
...
function animal_info(doc) {
    ...
    var weight_units = weight_label.innerText.match(/^Weight\s*\(([^\)]*)\)$/);
    if (weight_units) {
        weight_units = units.abbr_to_id(units.Mass, weight_units[1]);
    }
    if (weight && weight_units) {
        weight = units.convert(parseFloat(weight), units.Mass, weight_units, "kilograms");
    } else {
        weight = null;
    }
    ...
    // on the popup)
    dob = (0, _moment2.default)(dob, "MM-DD-YYYY");
    if (dob.isValid()) {
        dob = dob.valueOf();
    } else {
        dob = null;
...
function full_url(url) {
    ...
    return window.location.protocol + window.location.pathname + "/" + url;
}

function do_xhr(xhr, data) {
